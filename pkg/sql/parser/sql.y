...
func (u *sqlSymUnion) roleOptionWithValue() tree.OptionWithValue {
    return u.val.(tree.OptionWithValue)
}
func (u *sqlSymUnion) roleOptionWithValueList() tree.OptionsWithValues {
...
%type <tree.Statement> alter_user_or_role_stmt
...
%type <tree.Statement> create_user_or_role_stmt
...
%type <tree.Statement> drop_user_or_role_stmt
...
%type <tree.OptionsWithValues> role_options
...
| alter_user_or_role_stmt // EXTEND WITH HELP: ALTER USER
...
// CREATE ROLE
create_stmt:
  create_user_or_role_stmt     // EXTEND WITH HELP: CREATE USER
...
| drop_user_or_role_stmt     // EXTEND WITH HELP: DROP USER
| drop_unsupported   {}
...
password_clause:
  PASSWORD string_or_placeholder
  {
		...
		$$.val = tree.OptionWithValue{RoleOption: option, Value: $2.expr()}
  }
| PASSWORD NULL
  {
		option, err := roleoption.ToOption($1)
...
| CREATE role_or_group_or_user string_or_placeholder role_options
  {
    $$.val = &tree.CreateUserOrRole{Name: $3.expr(), IsRole: $2.isRole(), OptionsWithValues: $4.roleOptionWithValueList()}
  }
| CREATE role_or_group_or_user string_or_placeholder WITH role_options
  {
    $$.val = &tree.CreateUserOrRole{Name: $3.expr(), IsRole: $2.isRole(), HasWith: true, OptionsWithValues: $5.roleOptionWithValueList()}
  }
| CREATE role_or_group_or_user IF NOT EXISTS string_or_placeholder role_options
  {
    $$.val = &tree.CreateUserOrRole{Name: $6.expr(), IsRole: $2.isRole(), IfNotExists: true, OptionsWithValues: $7.roleOptionWithValueList()}
  }
| CREATE role_or_group_or_user IF NOT EXISTS string_or_placeholder WITH role_options
  {
    $$.val = &tree.CreateUserOrRole{Name: $6.expr(), IsRole: $2.isRole(), IfNotExists: true, HasWith: true, OptionsWithValues: $8.roleOptionWithValueList()}
  }
...
{
	$$.val = &tree.AlterUserOrRoleOptions{Name: $3.expr(), IsRole: $2.isRole(), OptionsWithValues: $4.roleOptionWithValueList()}
}
| ALTER role_or_group_or_user string_or_placeholder WITH role_options
{
	$$.val = &tree.AlterUserOrRoleOptions{Name: $3.expr(), IsRole: $2.isRole(), HasWith: true, OptionsWithValues: $5.roleOptionWithValueList()}
}
| ALTER role_or_group_or_user IF EXISTS string_or_placeholder role_options
{
	$$.val = &tree.AlterUserOrRoleOptions{Name: $5.expr(), IsRole: $2.isRole(), IfExists: true, OptionsWithValues: $6.roleOptionWithValueList()}
}
| ALTER role_or_group_or_user IF EXISTS string_or_placeholder WITH role_options
{
	$$.val = &tree.AlterUserOrRoleOptions{Name: $5.expr(), IsRole: $2.isRole(), IfExists: true, HasWith: true, OptionsWithValues: $7.roleOptionWithValueList()}
}
...
role_options:
	role_option
	{
		roleOptionWithValueList := make(tree.OptionsWithValues, 1)
