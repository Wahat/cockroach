...
%type <tree.RoleOptionWithValue> role_option password_clause
...
%type <tree.RoleOptionsWithValues> role_options
...
password_clause:
  PASSWORD string_or_placeholder
  {
		...
		$$.val = tree.RoleOptionWithValue{RoleOption: option, Value: $2.expr()}
  }
| PASSWORD NULL
  {
		option, err := roleoption.ToOption($1)
...
role_option:
  CREATEROLE
  {
		...
		$$.val = tree.RoleOptionWithValue{RoleOption: option, Value: nil}
  }
  | NOCREATEROLE
  {
		option, err := roleoption.ToOption($1)
