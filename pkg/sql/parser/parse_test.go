...
func TestParse2(t *testing.T) {
	testData := []struct {
		...
		{`CREATE ROLE foo WITH CREATEROLE`,
			`CREATE ROLE foo WITH CREATEROLE`},
		{`CREATE ROLE foo WITH NOCREATEROLE`,
			`CREATE ROLE foo WITH NOCREATEROLE`},
		{`CREATE ROLE IF NOT EXISTS foo WITH CREATEROLE`,
			`CREATE ROLE IF NOT EXISTS foo WITH CREATEROLE`},
		{`CREATE ROLE IF NOT EXISTS foo WITH NOCREATEROLE`,
			`CREATE ROLE IF NOT EXISTS foo WITH NOCREATEROLE`},
		{`CREATE ROLE foo CREATEROLE`,
			`CREATE ROLE foo CREATEROLE`},
		{`CREATE ROLE foo NOCREATEROLE`,
			`CREATE ROLE foo NOCREATEROLE`},
		{`CREATE ROLE IF NOT EXISTS foo CREATEROLE`,
			`CREATE ROLE IF NOT EXISTS foo CREATEROLE`},
		{`CREATE ROLE IF NOT EXISTS foo NOCREATEROLE`,
			`CREATE ROLE IF NOT EXISTS foo NOCREATEROLE`},
		{`ALTER ROLE foo WITH CREATEROLE`,
			`ALTER ROLE foo WITH CREATEROLE`},
		{`ALTER ROLE foo WITH NOCREATEROLE`,
			`ALTER ROLE foo WITH NOCREATEROLE`},
